...
goog.exportSymbol('proto.zzz.Account', null, global);
goog.exportSymbol('proto.zzz.AccountList', null, global);
 ...
 * @constructor
 */
proto.zzz.Account = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.zzz.Account, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.zzz.Account.displayName = 'proto.zzz.Account';
}
 ...
 * @return {!Object}
 */
proto.zzz.Account.prototype.toObject = function(opt_includeInstance) {
  return proto.zzz.Account.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.zzz.Account} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.zzz.Account.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.zzz.Account.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.zzz.Account;
  return proto.zzz.Account.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.zzz.Account} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.zzz.Account}
 */
proto.zzz.Account.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.zzz.Account.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.zzz.Account.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.zzz.Account} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.zzz.Account.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.zzz.Account.prototype.getAccountname = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.zzz.Account.prototype.setAccountname = function(value) {
 ...
 * @return {string}
 */
proto.zzz.Account.prototype.getPwd = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.zzz.Account.prototype.setPwd = function(value) {
...
goog.object.extend(exports, proto.zzz);
